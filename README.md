...
- [vite-plugin-keywords](https://github.com/cueaz/vite-plugin-keywords) - Provides minifiable `Symbols` (keywords) to use in place of string literals and object keys for aggressive minification.
